...
class _HomeScreenState extends State<HomeScreen>
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('Aucun projet', style: TextStyle(
            color: Color(0xFF555555), fontSize: 16,
          )),
          const SizedBox(height: 8),
          const Text('Créez votre premier plan', style: TextStyle(
  ...
  void _openFromTemplate(PlanTemplate template) {
    _showNewProjectDialog(template);
  }

  void _showNewProjectDialog(PlanTemplate template) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: const Color(0xFF1E1E1E),
        title: Text('Nouveau projet', style: const TextStyle(color: Colors.white)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            const Text('Nom du projet', style: TextStyle(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.pop(ctx);
              _launchCanvas(template,
                  title: ctrl.text.isNotEmpty ? ctrl.text : template.name);
            },
  ...
  void _launchCanvas(PlanTemplate template, {required String title}) {
